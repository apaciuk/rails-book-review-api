...
def show
    json_response "Show review success", true, {review: @review}, :ok
...
def update
  if correct_user @review.user
    if @review.update review_params
        ...
        json_resonse "Updated review fail", false, {}, :unprocessable_entity
    end 
...
def destroy
    if correct_user @review.user
        if @review.destroy
            ...
            json_resonse "Deleted review fail", false, {}, :unprocessable_entity
        end 
        json_response "You dont have permission to do this", false, {}, :unauthorized
end
end
